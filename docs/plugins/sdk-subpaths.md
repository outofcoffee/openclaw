...
<AccordionGroup>
  <Accordion title="Channel subpaths">
    ...
    | `plugin-sdk/channel-ingress` | Experimental channel ingress access graph helpers for state resolution, decision composition, redacted access-facts projection, turn-admission mapping, and simple string subject/adapter construction. Use only from migrated channel runtime paths. |
